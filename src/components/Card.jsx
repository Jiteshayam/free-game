  ...
  return (
    <div className="w-[350px] h-[280px] bg-bgDark2 text-white relative Game-Thumbnail ">
      ...
      <div className="relative z-0">
        ...
        <div onClick={ClickHandler} className="w-[40px] h-[40px] bg-[#c8c8c8] bg-opacity-80
         rounded-full absolute right-2 -bottom-3 flex justify-center cursor-pointer hover:scale-105 duration-100 transition-scale">
          
            {BookmarkedGames.includes(Game.id) ?
              (<button className="text-red"><BsFillBookmarkCheckFill fontSize='1.3rem' /></button>):
              (<button className="text-red"><BsBookmark fontSize='1.3rem' /></button>)
